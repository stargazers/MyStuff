<?php
	...
	/*
	Registeration form. Part of My Stuff -project.
	...
	*/	
	...
	function check_post_values()
	{
		...
		$_POST['ms_username'] = preg_replace( '/\./', '', 
			$_POST['ms_username'] );
		...
		// If users exists
		if( file_exists( 'users/' . $_POST['ms_username'] . '.txt' ) )
		{
		...
		$fh = @fopen( 'users/' . $_POST['ms_username'] . '.txt', 'w' );
		...
		$_SESSION['errorMsg'] = 'User ' . $_POST['ms_username'] 
			. ' is now registered!';
